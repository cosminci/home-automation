...
DEVICES = {
    ...
    "switch.ventilator": {"left": "57%", "top": "8%", "icon": "mdi:fan", "color_on": "blue"},
    ...
    "switch.light_2": {"left": "80%", "top": "43%", "icon": "mdi:wall-sconce", "color_on": "orange"},
    ...
    "switch.ceiling_spots_2": {"left": "48%", "top": "47%", "icon": "mdi:spotlight", "color_on": "orange"},
    "switch.ventilator_2": {"left": "40%", "top": "47%", "icon": "mdi:fan", "color_on": "blue"},
