from dashboard_helpers import mushroom_readonly, mushroom_climate
        ...
        "cards": [
            ...
            # Car
            {
                ...
                "cards": [
                    ...
                    {"type": "conditional", "conditions": [{"entity": "binary_sensor.tucson_trunk", "state": "on"}],
                     "card": mushroom_readonly("binary_sensor.tucson_trunk", "mdi:car-back", "red")},
                    {"type": "conditional", "conditions": [{"entity": "binary_sensor.tucson_hood", "state": "on"}],
                    ...
                    {"type": "conditional",
                     ...
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_tire_pressure_all", "mdi:car-tire-alert", "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_tire_pressure_front_left", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_tire_pressure_front_left", "mdi:car-tire-alert",
                                           "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_tire_pressure_front_right", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_tire_pressure_front_right", "mdi:car-tire-alert",
                                           "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_tire_pressure_rear_left", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_tire_pressure_rear_left", "mdi:car-tire-alert",
                                           "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_tire_pressure_rear_right", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_tire_pressure_rear_right", "mdi:car-tire-alert",
                                           "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_fuel_low_level", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_fuel_low_level", "mdi:gas-station-off", "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_smart_key_battery_warning", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_smart_key_battery_warning", "mdi:key-alert", "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_washer_fluid_warning", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_washer_fluid_warning", "mdi:wiper-wash", "red")]}},
                    {"type": "conditional",
                     "conditions": [{"entity": "binary_sensor.tucson_brake_fluid_warning", "state": "on"}],
                     "card": {"type": "grid", "columns": 1, "square": False, "cards": [
                         mushroom_readonly("binary_sensor.tucson_brake_fluid_warning", "mdi:car-brake-alert", "red")]}}
                ]
            }
        ]
    }
